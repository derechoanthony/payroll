        ...
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="sss_no" class="control-label">SSS No.</label>
                        <input type="number" step="any" name="sss_no" id="sss_no" required class="form-control form-control-sm rounded-0 text-end" value="<?php echo isset($sss_no) ? $sss_no : '' ?>" maxlength="25">
                    </div>
                    <div class="form-group">
                        <label for="phealth_no" class="control-label">PhilHealth No.</label>
                        <input type="number" step="any" name="phealth_no" id="phealth_no" required class="form-control form-control-sm rounded-0 text-end" 
                        value="<?php echo isset($phealth_no) ? $phealth_no : '' ?>" maxlength="25">
                    </div>
                    <div class="form-group">
                        <label for="hmdf_no" class="control-label">HMDF No.</label>
                        <input type="number" step="any" name="hmdf_no" id="hmdf_no" required class="form-control form-control-sm rounded-0 text-end" 
                        value="<?php echo isset($hmdf_no) ? $hmdf_no : '' ?>" maxlength="25">
                    </div>
                    <div class="form-group">
